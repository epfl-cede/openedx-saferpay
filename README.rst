...
Then configure your Ecommerce instance to use the Saferpay payment processor::
    ...
    tutor config save --set 'ECOMMERCE_ENABLED_CLIENT_SIDE_PAYMENT_URLS={"saferpay": "openedx_saferpay.processor.Saferpay"}'
    tutor config save --set 'ECOMMERCE_EXTRA_PAYMENT_PROCESSOR_CLASSES=["openedx_saferpay.urls"]'
